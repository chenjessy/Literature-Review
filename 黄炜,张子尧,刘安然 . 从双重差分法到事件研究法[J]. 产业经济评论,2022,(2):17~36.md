...
$Y_{it}$: the outcome variable

$D_i$: dummy variable of group (treatment or control)

$T_t$: dummy variable of policy time (pre or post)

$D_i \times T_t$: interaction term

$\beta$: the coefficient for causal effect
