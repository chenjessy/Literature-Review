...
4. Problems need to be paid attention to
   ...
   Need to be cautious to control for the inter-group linear trend. When there is a collinearity problem between $D_i \times Trend_t$ and $D_i \times Post_t$, the estimation efficiency will be decreased as the standard errors are increased (in 4a, the distribution of coefficient estimates with inter-group linear trend control is more dispersed). And controling for inter-group trend may absorb part of the treatment effect when the treatment effect is dynamic, which will underestimate the treatment effect (4b).
